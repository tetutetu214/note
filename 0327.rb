...
前回の[Qiita](https://qiita.com/)の記事__[知識0から175時間で合格したAWS認定ソリューションアーキテクト-アソシエイト-](https://qiita.com/i3no29/items/c9b2aaa4e78835b024cd)__が__キッカケ__となりまして、__駆け出しエンジニア__にランクアップとなりました。3月入社なので5日目エンジニアということになります。AWSに関して今年1月からの2ヶ月目、未経験からの__よわよわエンジニア__ですが、__誰かの役にたちますように__。

今回は入社してから構築しています、__VPC__についてのハンズオン記事を書いていきます。

ほぼ同じ内容ですが弊社技術ブログリンクも貼らせてください
[【初学者向け】AWSハンズオン①VPC構築](https://cloud5.jp/%e3%80%90%e5%88%9d%e5%ad%a6%e8%80%85%e5%90%91%e3%81%91%e3%80%91aws%e3%83%8f%e3%83%b3%e3%82%ba%e3%82%aa%e3%83%b3%e2%91%a0vpc%e6%a7%8b%e7%af%89/)

## 前提
・すでにAWSのアカウントを取得しているものとします、[サインアップへのリンクはココから](https://aws.amazon.com/jp/)

## 概要
AWSの環境__（①VPC〜②サブネット〜③ルートテーブル〜④インターネットゲートウェイ）__までを構築していく手順をハンズオン形式で公開していきます。
最後まで読めば、下記図の構築ができることを目指します（制作目安：15分）
__※2021/03/07　変更__
![スクリーンショット 2021-03-07 9.24.38.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/694365/fd5e1f20-b917-92b2-fe57-6fed699cfa82.png)
